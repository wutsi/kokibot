...
- Contains: home directory, LLM instance, ToolRegistry, SkillRegistry, CommandRegistry, ChatHistory, Memory, SMTP, IMAP, JsonMapper
...
Skills are modular extensions that dynamically activate tools based on user intent. Skills are discovered from `~/kokibot/skills/` directory.
